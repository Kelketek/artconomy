...
class TestLineCalculations(TestCase):
    ...
    def test_get_totals_single_line(self):
        ...
        self.assertEqual(
            ...
            (
                ...
                Money("0.00", "USD"),
                {
                    LineItemSim(amount=Money("10.00", "USD"), priority=0, id=1): Money(
                        "10.00", "USD"
                    )
                },
            ),
        ...
        self.assertEqual(
            ...
            (
                ...
                Money("0.00", "USD"),
                {
                    ...
                    LineItemSim(percentage=Decimal(10), priority=1, id=2): Money(
                        "1.00", "USD"
                    ),
                },
            ),
    ...
    def test_get_totals_percentage_with_static(self):
        source = [
            LineItemSim(amount=Money("10.00", "USD"), priority=0, id=1),
            LineItemSim(
                percentage=Decimal(10), amount=Money(".25", "USD"), priority=1, id=2
            ),
        ]
        result = get_totals(source)
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            (
                ...
                Money("0.00", "USD"),
                {
                    ...
                    LineItemSim(percentage=Decimal(5), priority=1, id=3): Money(
                        ".50", "USD"
                    ),
                },
            ),
    ...
    def test_get_totals_concurrent_priorities_cascade(self):
        source = [
            ...
            LineItemSim(
                percentage=Decimal(5), priority=1, cascade_percentage=True, id=3
            ),
        ]
        result = get_totals(source)
        self.assertEqual(
    ...
    def test_get_totals_multi_priority_cascade_on_concurrent_priority(self):
        ...
        self.assertEqual(
            ...
            (
                ...
                Money("0.00", "USD"),
                {
                    LineItemSim(amount=Money("2.00", "USD"), priority=0, id=1): Money(
                        "1.44", "USD"
                    ),
                    LineItemSim(amount=Money("8.00", "USD"), priority=0, id=2): Money(
                        "5.76", "USD"
                    ),
                    LineItemSim(
                        percentage=Decimal(20),
    ...
    def test_fixed_point_decisions(self):
        ...
        self.assertEqual(
            ...
            (
                ...
                Money("0.00", "USD"),
                {
                    LineItemSim(amount=Money("100", "USD"), priority=0, id=1): Money(
                        "82.57", "USD"
                    ),
                    LineItemSim(amount=Money("5.00", "USD"), priority=100, id=2): Money(
                        "4.12", "USD"
                    ),
                    LineItemSim(
                        amount=Money("5.00", "USD"),
    ...
    def test_fixed_point_calculations_2(self):
        ...
        self.assertEqual(
            ...
            (
                ...
                Money("0.00", "USD"),
                {
                    LineItemSim(amount=Money("20", "USD"), priority=0, id=1): Money(
                        "16.51", "USD"
                    ),
                    LineItemSim(
                        amount=Money("10.00", "USD"), priority=100, id=2
                    ): Money("8.25", "USD"),
                    LineItemSim(
                        amount=Money("5.00", "USD"),
                        percentage=Decimal(10),
    ...
    def test_zero_total(self):
        ...
        self.assertEqual(
            ...
            (
                ...
                Money("0.00", "USD"),
                {
                    LineItemSim(amount=Money("0", "USD"), priority=0, id=1): Money(
                        "-8.00", "USD"
                    ),
                    LineItemSim(
    ...
    def test_negative_distribution(self):
        ...
        source = [
            ...
            LineItemSim(
                amount=Money("8", "USD"), cascade_amount=True, priority=100, id=4
            ),
        ]
        result = get_totals(source)
        self.assertEqual(
            ...
            (
                ...
                Money("0.00", "USD"),
                {
                    LineItemSim(id=1, priority=0, amount=Money("1", "USD")): Money(
                        "-0.34", "USD"
                    ),
                    LineItemSim(id=2, priority=1, amount=Money("1", "USD")): Money(
                        "-0.33", "USD"
                    ),
                    LineItemSim(id=3, priority=1, amount=Money("4", "USD")): Money(
                        "-1.33", "USD"
                    ),
                    LineItemSim(
                        id=4,
    ...
    def test_non_cascading_percentage(self):
        ...
        source = [
            ...
            LineItemSim(amount=Money("4", "USD"), priority=1, id=3),
            LineItemSim(
                percentage=Decimal("5"), back_into_percentage=True, priority=100, id=4
            ),
        ]
        result = get_totals(source)
        self.assertEqual(
    ...
    def test_handles_many_transactions_divvied_up_for_fees(self):
        source = [
            LineItemSim(
                amount=Money("25.00", "USD"), priority=0, cascade_amount=False, id=1
            ),
            LineItemSim(
                amount=Money("25.00", "USD"), priority=0, cascade_amount=False, id=2
            ),
            LineItemSim(
                amount=Money("35.00", "USD"), priority=0, cascade_amount=False, id=3
            ),
            LineItemSim(
                amount=Money("55.00", "USD"), priority=0, cascade_amount=False, id=4
            ),
            LineItemSim(
                amount=Money("10.00", "USD"), priority=0, cascade_amount=False, id=5
            ),
            LineItemSim(
                amount=Money("5.00", "USD"), priority=0, cascade_amount=False, id=6
            ),
            LineItemSim(
                amount=Money("30.00", "USD"), priority=0, cascade_amount=False, id=7
            ),
            LineItemSim(
                amount=Money("55.00", "USD"), priority=0, cascade_amount=False, id=8
            ),
            LineItemSim(
                amount=Money("25.00", "USD"), priority=0, cascade_amount=False, id=9
            ),
            LineItemSim(
                amount=Money("5.00", "USD"), priority=0, cascade_amount=False, id=10
            ),
            LineItemSim(
                amount=Money("6.00", "USD"), priority=0, cascade_amount=False, id=11
            ),
            LineItemSim(
                amount=Money("25.00", "USD"), priority=0, cascade_amount=False, id=12
            ),
            LineItemSim(
                amount=Money("6.00", "USD"), priority=0, cascade_amount=False, id=13
            ),
            LineItemSim(
                amount=Money("3.00", "USD"), priority=0, cascade_amount=False, id=14
            ),
            LineItemSim(
                amount=Money("5.00", "USD"), priority=0, cascade_amount=False, id=15
            ),
            LineItemSim(
                amount=Money("10.06", "USD"), priority=1, cascade_amount=True, id=16
            ),
        ]
        result = get_totals(source)
        self.assertEqual(
