...
def build_initial_plans():
    ...
    free, _ = ServicePlan.objects.update_or_create(
        ...
        defaults=dict(
            ...
            shield_percentage_price=Decimal("3.25"),
            features=[
    ...
    ServicePlan.objects.update_or_create(
        ...
        defaults=dict(
            ...
            shield_static_price=Money("0.50", "USD"),
            shield_percentage_price=Decimal("3.00"),
            sort_value=1,
            features=[
                "Slick, mobile-friendly storefront",
                "Built-in order forms",
    ...
    ServicePlan.objects.update_or_create(
        ...
        defaults=dict(
            ...
            shield_percentage_price=Decimal("1.25"),
    ...
    User.objects.filter(next_service_plan__isnull=True).update(
        next_service_plan=F("service_plan")
    )
