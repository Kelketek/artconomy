# Generated by Django 2.2.1 on 2019-10-16 18:48
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='payee',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='old_credits', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AlterField(
            model_name='paymentrecord',
            name='payer',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='old_debits', to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.IntegerField(choices=[(400, 'Artconomy Service Fee'), (401, 'Escrow hold'), (402, 'Escrow release'), (403, 'Escrow refund'), (404, 'Subscription dues'), (405, 'Refund for subscription dues'), (406, 'Cash withdrawal'), (407, 'Cash deposit'), (408, 'Third party fee'), (409, 'Premium service bonus'), (410, 'Internal Transfer')], db_index=True)),
                ('created_on', models.DateTimeField(db_index=True, default=django.utils.timezone.now)),
                ('finalized_on', models.DateTimeField(db_index=True, default=None, null=True)),
                ...
                ('amount', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='USD', max_digits=6)),
                ('object_id', models.PositiveIntegerField(blank=True, db_index=True, null=True)),
                ('remote_id', models.CharField(max_length=40)),
                ('response_message', models.TextField(default='')),
                ('note', models.TextField(blank=True, default='')),
                ('card', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='sales.CreditCardToken')),
                ('content_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='contenttypes.ContentType')),
                ('payee', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='credits', to=settings.AUTH_USER_MODEL)),
                ('payer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='debits', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
