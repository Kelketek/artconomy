# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-11-11 23:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.IntegerField(choices=[(0, 'Credit Card'), (1, 'Bank Transfer')], db_index=True)),
                ('status', models.IntegerField(choices=[(0, 'SUCCESS'), (1, 'FAILURE')], db_index=True)),
                ('payment_type', models.IntegerField(choices=[(0, 'Sale of good or service'), (1, 'Disbursement to account'), (3, 'Refund')], db_index=True)),
                ...
                ('amount', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='USD', max_digits=4)),
                ...
                ('payee', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='paid', to=settings.AUTH_USER_MODEL)),
                ('payer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='paid_for', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AlterField(
            model_name='order',
            name='price',
            field=djmoney.models.fields.MoneyField(blank=True, decimal_places=2, default=None, default_currency='USD', max_digits=4, null=True, validators=[django.core.validators.MinValueValidator(Decimal('1.10'))]),
        ),
        migrations.AlterField(
            model_name='product',
            name='price',
            field=djmoney.models.fields.MoneyField(db_index=True, decimal_places=2, default=Decimal('0.0'), default_currency='USD', max_digits=6, validators=[django.core.validators.MinValueValidator(Decimal('1.10'))]),
        ),
    ]
