# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-11-11 21:15
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='order',
            name='price',
            field=djmoney.models.fields.MoneyField(blank=True, decimal_places=2, default=None, default_currency='USD', max_digits=4, null=True, validators=[django.core.validators.MinValueValidator(Decimal('1.100000000000000088817841970012523233890533447265625'))]),
        ),
        migrations.AddField(
            model_name='order',
            name='price_currency',
        ...
        migrations.AlterField(
            model_name='product',
            name='price',
            field=djmoney.models.fields.MoneyField(db_index=True, decimal_places=2, default=Decimal('0.0'), default_currency='USD', max_digits=6, validators=[django.core.validators.MinValueValidator(Decimal('1.100000000000000088817841970012523233890533447265625'))]),
        ),
    ]
