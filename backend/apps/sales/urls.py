...
urlpatterns = [
    ...
    path(
        "v1/order/<int:order_id>/deliverables/<int:deliverable_id>/outputs/",
        main.DeliverableOutputs.as_view(),
        name="accept_order",
    ),
    path(
        "v1/order/<int:order_id>/deliverables/<int:deliverable_id>/characters/",
        main.DeliverableCharacterList.as_view(),
        name="accept_order",
    ),
    path(
        "v1/order/<int:order_id>/deliverables/<int:deliverable_id>/revisions/",
        main.DeliverableRevisions.as_view(),
        name="deliverable_revisions",
    ),
    path(
        "v1/order/<int:order_id>/deliverables/<int:deliverable_id>/line-items/",
    ...
    path(
        "v1/order/<int:order_id>/deliverables/<int:deliverable_id>/accept/",
        main.DeliverableAccept.as_view(),
        name="accept_order",
    ),
    path(
        "v1/order/<int:order_id>/deliverables/<int:deliverable_id>/waitlist/",
        main.WaitlistOrder.as_view(),
        name="waitlist",
    ),
    path(
        "v1/order/<int:order_id>/deliverables/<int:deliverable_id>/start/",
        main.DeliverableStart.as_view(),
        name="start_order",
    ),
    path(
        "v1/order/<int:order_id>/deliverables/<int:deliverable_id>/cancel/",
        main.DeliverableCancel.as_view(),
        name="cancel_order",
    ),
    path(
        "v1/order/<int:order_id>/deliverables/<int:deliverable_id>/mark-paid/",
        main.MarkPaid.as_view(),
        name="mark_paid",
    ),
    path(
        "v1/order/<int:order_id>/deliverables/<int:deliverable_id>/approve/",
        main.ApproveFinal.as_view(),
        name="approve_final",
    ),
    path(
        "v1/order/<int:order_id>/deliverables/<int:deliverable_id>/dispute/",
        main.StartDispute.as_view(),
        name="approve_final",
    ),
    path(
        "v1/order/<int:order_id>/deliverables/<int:deliverable_id>/claim/",
        main.ClaimDispute.as_view(),
        name="deliverable_claim_dispute",
    ),
    path(
        "v1/order/<int:order_id>/deliverables/<int:deliverable_id>/complete/",
        main.MarkComplete.as_view(),
        name="deliverable_complete",
    ),
    path(
        "v1/order/<int:order_id>/deliverables/<int:deliverable_id>/reopen/",
        main.ReOpen.as_view(),
        name="deliverable_reopen",
    ),
    path(
        "v1/order/<int:order_id>/deliverables/<int:deliverable_id>/refund/",
        main.DeliverableRefund.as_view(),
        name="deliverable_refund",
    ),
    path(
        "v1/order/<int:order_id>/deliverables/<int:deliverable_id>/",
        main.DeliverableManager.as_view(),
        name="deliverable",
    ),
    path(
        "v1/order/<int:order_id>/deliverables/<int:deliverable_id>/rate/buyer/",
        main.RateBuyer.as_view(),
        name="deliverable_rate_buyer",
    ),
    path(
        "v1/order/<int:order_id>/deliverables/<int:deliverable_id>/rate/seller/",
        main.RateSeller.as_view(),
        name="deliverable_rate_seller",
    ),
    path(
        "v1/order/<int:order_id>/deliverables/<int:deliverable_id>/invite/",
        main.DeliverableInvite.as_view(),
        name="order_invite",
    ),
    path(
        "v1/order/<int:order_id>/deliverables/<int:deliverable_id>/issue-tip-invoice/",
        main.IssueTipInvoice.as_view(),
        name="issue_tip_invoices",
    ),
    path(
        "v1/order/<int:order_id>/deliverables/",
    ...
    path(
        "v1/search/product/<username>/",
        main.PersonalProductSearch.as_view(),
        name="personal_product_search",
    ),
    path(
        "v1/account/<username>/premium/intent/",
        stripe_views.PremiumPaymentIntent.as_view(),
        name="premium_intent",
    ),
    path(
        "v1/account/<username>/broadcast/", main.Broadcast.as_view(), name="broadcast"
    ),
    path(
        "v1/account/<username>/cancel-premium/",
        main.CancelPremium.as_view(),
        name="cancel_premium",
    ),
    path(
        "v1/account/<username>/products/",
        main.ProductList.as_view(),
        name="product_list",
    ),
    path(
        "v1/account/<username>/products/<int:product>/",
        main.ProductManager.as_view(),
        name="product_manager",
    ),
    path(
        "v1/account/<username>/products/manage/",
        main.ProductList.as_view(),
        kwargs={"manage": True},
        name="product_list",
    ),
    path(
        "v1/account/<username>/products/manage/<int:product>/",
        main.ProductManager.as_view(),
        name="product_manager",
    ),
    path(
        "v1/account/<username>/products/manage/<int:product>/up/",
        main.StoreShift.as_view(),
        kwargs={"delta": 1},
        name="store_shift_up",
    ),
    path(
        "v1/account/<username>/products/manage/<int:product>/down/",
        main.StoreShift.as_view(),
        kwargs={"delta": -1},
        name="store_shift_down",
    ),
    path(
        "v1/account/<username>/products/<int:product>/clear-waitlist/",
        main.ClearWaitlist.as_view(),
        name="clear_waitlist",
    ),
    path(
        "v1/account/<username>/products/<int:product>/feature/",
        main.FeatureProduct.as_view(),
        name="feature_product",
    ),
    path(
        "v1/account/<username>/products/<int:product>/inventory/",
    ...
    path(
        "v1/account/<username>/create-invoice/",
        main.CreateInvoice.as_view(),
        name="create_invoice",
    ),
    path(
        "v1/account/<username>/ratings/", main.RatingList.as_view(), name="rating_list"
    ),
    path(
        "v1/account/<username>/products/<int:product>/order/",
        main.PlaceOrder.as_view(),
        name="place_order",
    ),
    path(
        "v1/account/<username>/orders/waiting/",
        main.WaitingOrderList.as_view(),
        name="waiting_orders",
    ),
    path(
        "v1/account/<username>/orders/current/",
        main.CurrentOrderList.as_view(),
        name="current_orders",
    ),
    path(
        "v1/account/<username>/orders/archived/",
        main.ArchivedOrderList.as_view(),
        name="archived_orders",
    ),
    path(
        "v1/account/<username>/orders/cancelled/",
        main.CancelledOrderList.as_view(),
        name="archived_orders",
    ),
    path(
        "v1/account/<username>/queue/",
        main.PublicSalesQueue.as_view(),
        name="public_queue",
    ),
    path(
        "v1/account/<username>/sales/stats/",
        main.SalesStats.as_view(),
        name="sales_stats",
    ),
    path(
        "v1/account/<username>/sales/current/",
        main.CurrentSalesList.as_view(),
        name="current_sales",
    ),
    path(
        "v1/account/<username>/sales/archived/",
        main.ArchivedSalesList.as_view(),
        name="archived_sales",
    ),
    path(
        "v1/account/<username>/sales/cancelled/",
        main.CancelledSalesList.as_view(),
        name="cancelled_sales",
    ),
    path(
        "v1/account/<username>/sales/waiting/",
        main.SearchWaiting.as_view(),
        name="waiting_sales",
    ),
    path(
        "v1/account/<username>/cases/current/",
        main.CurrentCasesList.as_view(),
        name="current_cases",
    ),
    path(
        "v1/account/<username>/cases/archived/",
        main.ArchivedCasesList.as_view(),
        name="archived_cases",
    ),
    path(
        "v1/account/<username>/cases/cancelled/",
        main.CancelledCasesList.as_view(),
        name="cancelled_cases",
    ),
    path(
        "v1/account/<username>/cases/waiting/",
        main.WaitingCasesList.as_view(),
        name="cancelled_cases",
    ),
    path("v1/account/<username>/cards/", main.CardList.as_view(), name="list_cards"),
    path(
        "v1/account/<username>/cards/stripe/",
        main.CardList.as_view(),
        name="list_cards",
        kwargs={"stripe": True},
    ),
    path(
        "v1/account/<username>/cards/stripe/<int:card_id>/",
        main.CardManager.as_view(),
        name="card_manager",
    ),
    path(
        "v1/account/<username>/cards/setup-intent/",
        stripe_views.SetupIntent.as_view(),
        name="setup_intent",
    ),
    path(
        "v1/account/<username>/cards/<int:card_id>/",
        main.CardManager.as_view(),
        name="card_manager",
    ),
    path(
        "v1/account/<username>/cards/<int:card_id>/primary/",
        main.MakePrimary.as_view(),
        name="card_primary",
    ),
    path(
        "v1/account/<username>/balance/",
        main.AccountBalance.as_view(),
        name="account_balance",
    ),
    path("v1/account/<username>/set-plan/", main.SetPlan.as_view(), name="set_plan"),
    path(
        "v1/account/<username>/stripe-accounts/",
        stripe_views.StripeAccounts.as_view(),
        name="stripe_account_list",
    ),
    path(
        "v1/account/<username>/stripe-accounts/link/",
        stripe_views.StripeAccountLink.as_view(),
        name="stripe_account_link",
    ),
    path(
        "v1/account/<username>/account-status/",
        main.AccountStatus.as_view(),
        name="account_status",
    ),
    path(
        "v1/account/<username>/transactions/",
        main.AccountHistory.as_view(),
        name="account_history",
    ),
    path(
        "v1/account/<username>/reports/payout/",
        reports.UserPayoutReportCSV.as_view(),
        name="account_payouts",
    ),
    path(
        "v1/account/<username>/invoices/",
    ...
    path(
        "v1/invoice/<short_code:invoice>/",
        main.InvoiceDetail.as_view(),
        name="invoice_detail",
    ),
    path(
        "v1/invoice/<short_code:invoice>/pay/",
        main.InvoicePayment.as_view(),
        name="invoice_payment",
    ),
    path(
        "v1/invoice/<short_code:invoice>/finalize/",
        main.FinalizeInvoice.as_view(),
        name="invoice_finalize",
    ),
    path(
        "v1/invoice/<short_code:invoice>/void/",
        main.VoidInvoice.as_view(),
        name="invoice_void",
    ),
    path(
        "v1/invoice/<short_code:invoice>/payment-intent/",
