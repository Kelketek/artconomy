...
urlpatterns = [
    ...
    path('v1/order/<int:order_id>/deliverables/<int:deliverable_id>/pay/', main.DeliverablePayment.as_view(), name='make_payment'),
    ...
    path('v1/invoice/<short_code:invoice>/line-items/', main.InvoiceLineItems.as_view(), name='invoice_payment_intent'),
