...
urlpatterns = [
    ...
    path(
        "v1/forgot-password/token-check/<username>/<reset_token>/",
        views.TokenValidator.as_view(),
        name="reset_token_check",
    ),
    path(
        "v1/forgot-password/perform-reset/<username>/<reset_token>/",
    ...
    path(
        "v1/data/requester/", views.CurrentUserInfo.as_view(), name="current_user_info"
    ),
    path(
        "v1/data/notifications/unread/",
        views.UnreadNotifications.as_view(),
        name="unread_notifications",
    ),
    path(
        "v1/data/notifications/mark-read/",
        views.MarkNotificationsRead.as_view(),
        name="mark_read",
    ),
    path(
        "v1/data/notifications/community/",
        views.CommunityNotificationsList.as_view(),
        name="community_notifications",
    ),
    path(
        "v1/data/notifications/sales/",
        views.SalesNotificationsList.as_view(),
        name="sales_notifications",
    ),
    path(
        "v1/data/user/id/<int:user_id>/", views.UserInfoByID.as_view(), name="user_info"
    ),
    path(
        "v1/data/character/id/<int:character_id>/",
        views.CharacterById().as_view(),
        name="character_info_by_id",
    ),
    path(
        "v1/search/character/", views.CharacterSearch.as_view(), name="character_search"
    ),
    path(
        "v1/search/character/indexed/",
    ...
    path(
        "v1/account/<username>/auth/two-factor/totp/",
        views.TOTPDeviceList.as_view(),
        name="totp_list",
    ),
    path(
        "v1/account/<username>/auth/two-factor/tg/",
        views.Telegram2FA.as_view(),
        name="telegram_2fa",
    ),
    path(
        "v1/account/<username>/referral_stats/",
    ...
    path(
        "v1/account/<username>/favorites/",
        views.FavoritesList.as_view(),
        name="favorites_list",
    ),
    path(
        "v1/account/<username>/journals/", views.Journals.as_view(), name="journal_list"
    ),
    path(
        "v1/account/<username>/journals/<int:journal_id>/",
        views.JournalManager.as_view(),
        name="journal",
    ),
    path(
        "v1/account/<username>/submissions/",
        views.SubmissionList.as_view(),
        name="art_list",
    ),
    path(
        "v1/account/<username>/submissions/sample-options/",
        views.RawArtistSubmissionList.as_view(),
        kwargs={"is_artist": True},
        name="art_list",
    ),
    path(
        "v1/account/<username>/submissions/art/",
    ...
    path(
        "v1/account/<username>/submissions/art/management/<short_code:tag_id>/",
        views.ArtRelationManager.as_view(),
        name="art_relation_manager",
    ),
    path(
        "v1/account/<username>/submissions/art/management/<short_code:tag_id>/up/",
        views.ArtRelationShift.as_view(),
        kwargs={"delta": 1},
        name="art_relation_shift_up",
    ),
    path(
        "v1/account/<username>/submissions/art/management/<short_code:tag_id>/down/",
        views.ArtRelationShift.as_view(),
        kwargs={"delta": -1},
        name="art_relation_shift_down",
    ),
    path(
        "v1/account/<username>/submissions/collection/",
        views.FilteredSubmissionList.as_view(),
        kwargs={"is_artist": False},
        name="collection_list",
    ),
    path(
        "v1/account/<username>/submissions/collection/management/",
        views.FilteredSubmissionList.as_view(),
        kwargs={"is_artist": False},
        name="collection_list",
    ),
    path(
        "v1/account/<username>/submissions/collection/management/<int:submission_id>/",
        views.SubmissionManager.as_view(),
    ),
    path(
        "v1/account/<username>/submissions/collection/management/<int:submission_id>/up/",
        views.CollectionShift.as_view(),
        kwargs={"delta": 1},
        name="collection_shift_up",
    ),
    path(
        "v1/account/<username>/submissions/collection/management/<int:submission_id>/down/",
        views.CollectionShift.as_view(),
        kwargs={"delta": -1},
        name="collection_shift_down",
    ),
    path(
        "v1/account/<username>/conversations/",
        views.Conversations.as_view(),
        name="conversations",
    ),
    path(
        "v1/account/<username>/conversations/<int:message_id>/",
    ...
    path(
        r"v1/submission/<int:submission_id>/artists/<short_code:tag_id>/",
    ...
    path(
        r"v1/account/<username>/characters/",
