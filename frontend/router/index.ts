...
const ProductDetail = () =>
  import("@/components/views/product/ProductDetail.vue")
const FAQ = () => import("@/components/views/faq/FAQ.vue")
const Submission = () =>
  import("@/components/views/submission/SubmissionDetail.vue")
const Search = () => import("@/components/views/search/Search.vue")
const PasswordReset = () => import("@/components/views/PasswordReset.vue")
const SearchProducts = () =>
  import("@/components/views/search/SearchProducts.vue")
const SearchCharacters = () =>
  import("@/components/views/search/SearchCharacters.vue")
const SearchProfiles = () =>
  import("@/components/views/search/SearchProfiles.vue")
const SearchSubmissions = () =>
  import("@/components/views/search/SearchSubmissions.vue")
const ProductHints = () =>
  import("@/components/views/search/hints/ProductHints.vue")
const SubmissionHints = () =>
  import("@/components/views/search/hints/SubmissionHints.vue")
const CharacterHints = () =>
  import("@/components/views/search/hints/CharacterHints.vue")
const ProfileHints = () =>
  import("@/components/views/search/hints/ProfileHints.vue")
const Home = () => import("@/components/views/Home.vue")
const ProductExtra = () =>
  import("@/components/views/search/extra/ProductExtra.vue")
const RedirectToViewer = () => import("@/components/views/RedirectToViewer.vue")
const RevisionDetail = () =>
  import("@/components/views/order/deliverable/RevisionDetail.vue")
const ReferenceDetail = () =>
  import("@/components/views/order/deliverable/ReferenceDetail.vue")
const DeliverableRevisions = () =>
  import("@/components/views/order/deliverable/DeliverableRevisions.vue")
const DeliverableOverview = () =>
  import("@/components/views/order/deliverable/DeliverableOverview.vue")
const DeliverablePayment = () =>
  import("@/components/views/order/deliverable/DeliverablePayment.vue")
const DeliverableReferences = () =>
  import("@/components/views/order/deliverable/DeliverableReferences.vue")
const DeliverableListing = () =>
  import("@/components/views/order/OrderDetail.vue")
const DeliverableDetail = () =>
  import("@/components/views/order/DeliverableDetail.vue")
...
const SubmissionExtra = () =>
  import("@/components/views/search/extra/SubmissionExtra.vue")
const ReferralsAndTools = () =>
  import("@/components/views/referrals/ReferralsAndTools.vue")
const LinksAndStats = () =>
  import("@/components/views/referrals/LinksAndStats.vue")
...
const ShieldCommissioner = () =>
  import("@/components/views/landing/ShieldCommissioner.vue")
...
const ConversationsList = () =>
  import("@/components/views/ConversationsList.vue")
...
const CharacterDetail = () =>
  import("@/components/views/character/CharacterDetail.vue")
const Purchase = () =>
  import("@/components/views/settings/payment/Purchase.vue")
const TransactionHistory = () =>
  import("@/components/views/settings/payment/TransactionHistory.vue")
...
const CommissionAgreement = () =>
  import("@/components/views/legal/CommissionAgreement.vue")
const RefundPolicy = () => import("@/components/views/legal/RefundPolicy.vue")
const TermsOfService = () =>
  import("@/components/views/legal/TermsOfService.vue")
...
const ManageProducts = () =>
  import("@/components/views/store/ManageProducts.vue")
const Reports = () => import("@/components/views/reports/Reports.vue")
const Journal = () => import("@/components/views/JournalDetail.vue")
const CharacterGallery = () =>
  import("@/components/views/character/CharacterGallery.vue")
const NotFound = () => import("@/components/views/NotFound.vue")
const ConversationDetail = () =>
  import("@/components/views/ConversationDetail.vue")
const SubmissionList = () =>
  import("@/components/views/profile/SubmissionList.vue")
const ManageSubmissionList = () =>
  import("@/components/views/profile/ManageSubmissionList.vue")
const ManageArtList = () =>
  import("@/components/views/profile/ManageArtList.vue")
const Queue = () => import("@/components/views/Queue.vue")
const InvoiceDetail = () =>
  import("@/components/views/invoice/InvoiceDetail.vue")
const VendorInvoices = () => import("@/components/views/VendorInvoices.vue")
const TableDashboard = () =>
  import("@/components/views/table/TableDashboard.vue")
...
const Invoices = () =>
  import("@/components/views/settings/payment/Invoices.vue")
const TroubledDeliverables = () =>
  import("@/components/views/TroubledDeliverables.vue")
...
export const router = createRouter({
  ...
  ): Promise<void | { left: number; top: number }> => {
    if (!from || !to) {
      return
    }
    if (
      from.name === to.name ||
      (from.matched[0] && from.matched[0].name === to.matched[0].name)
    ) {
  ...
  vueRouter.beforeEach((to, from) => {
    ...
    if (from.name !== to.name) {
      ...
      setMetaContent("description", "", {
        content:
          "Artconomy.com makes it easy, safe, and fun for you to get custom art of your original characters!",
      })
    }
