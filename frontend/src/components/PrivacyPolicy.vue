    ...
    <div class="row">
      ...
      <div class="col-12-sm">
        ...
        <p>Cookies are files with small amount of data which may include an anonymous unique identifier.
          ...
          are beacons, tags, and scripts to collect and track information and to improve and analyze our Service.</p>
        ...
        <p>Artconomy will take all steps reasonably necessary to ensure that your data is treated securely and in
        ...
        <p>Artconomy may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
        <ul>
