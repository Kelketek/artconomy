...
import {ProfileController, RawProfileController} from '@/store/profiles/controller.ts'

const {use, listen, clear} = generateModuleHooks<ProfileState, ProfileModuleOpts, RawProfileController>('Profile', RawProfileController)
