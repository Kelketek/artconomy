...
describe("Forms store", () => {
  ...
  test("Updates form data", () => {
    ...
    expect(state.example.fields.name.errors).toEqual(["Too cool."])
    store.commit("forms/updateValues", {
      name: "example",
      data: { name: "Wolf" },
    })
  ...
  test("Updates errors", () => {
    ...
    store.commit("forms/setErrors", {
      name: "example",
      errors: { fields: { name: ["Too cool."] }, errors: ["Borked."] },
    })
    expect(state.example.fields.name.errors).toEqual(["Too cool."])
  ...
  test("Updates meta errors", () => {
    ...
    store.commit("forms/setMetaErrors", {
      name: "example",
      errors: ["Borked."],
    })
    expect(state.example.errors).toEqual(["Borked."])
  ...
  test("Updates field errors", () => {
    store.commit("forms/initForm", {
      name: "example",
      fields: { name: { value: "Fox", errors: ["Too cool."] } },
    })
    store.commit("forms/setFieldErrors", {
      name: "example",
      fields: { name: ["Way too cool!"] },
    })
  ...
  test("Adds a field", () => {
    ...
    store.commit("forms/addField", {
      name: "example",
      field: { name: "sex", schema: { value: "Male" } },
    })
    expect(state.example.fields.name.value).toBe("Fox")
  ...
  test("Adds a field with errors", () => {
    ...
    store.commit("forms/addField", {
      ...
      field: {
        name: "sex",
        schema: { value: "Male", errors: ["So much dick!"] },
      },
    })
    expect(state.example.fields.name.value).toBe("Fox")
    expect(state.example.fields.sex.value).toBe("Male")
