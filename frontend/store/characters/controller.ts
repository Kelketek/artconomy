...
> {
  ...
  public profile: SingleController<Character> =
    null as unknown as SingleController<Character>
  public attributes: ListController<Attribute> =
    null as unknown as ListController<Attribute>
  public colors: ListController<Color> =
    null as unknown as ListController<Color>
  public submissions: ListController<Submission> =
    null as unknown as ListController<Submission>
  public sharedWith: ListController<TerseUser> =
    null as unknown as ListController<TerseUser>
  public recommended: ListController<Character> =
    null as unknown as ListController<Character>
  public submoduleKeys = [
    "profile",
    "attributes",
    "colors",
    "submissions",
  ...
  public constructor(args: ControllerArgs<CharacterModuleOpts>) {
    super(args)
    this.register()
    this.profile = getController<
      SingleState<Character>,
      SingleModuleOpts<Character>,
      SingleController<Character>
    >({
      uid: this._uid,
    ...
    this.attributes = getController<
      ListState<Attribute>,
      ListModuleOpts,
      ListController<Attribute>
    >({
      uid: this._uid,
    ...
    this.colors = getController<
      ListState<Color>,
      ListModuleOpts,
      ListController<Color>
    >({
      uid: this._uid,
    ...
    this.submissions = getController<
      ListState<Submission>,
      ListModuleOpts,
      ListController<Submission>
    >({
      uid: this._uid,
    ...
    this.sharedWith = getController<
      ListState<TerseUser>,
      ListModuleOpts,
      ListController<TerseUser>
    >({
      uid: this._uid,
    ...
    this.recommended = getController<
      ListState<Character>,
      ListModuleOpts,
      ListController<Character>
    >({
      uid: this._uid,
  ...
  public setEndpoints = () => {
    const baseEndpoint = characterEndpoint(
      this.attr("username"),
      this.attr("characterName"),
    )
