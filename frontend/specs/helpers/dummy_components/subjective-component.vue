...
const props = withDefaults(
  defineProps<
    SubjectiveProps & {
      isPrivate?: boolean
      isProtected?: boolean
      hasControlPowers?: StaffPower[]
    }
  >(),
  {
    isPrivate: false,
    isProtected: false,
    hasControlPowers: () => [] as StaffPower[],
  },
)
const route = useRoute()
const subjectValues = useSubject({
  props,
  privateView: props.isPrivate,
  controlPowers: props.hasControlPowers,
})
