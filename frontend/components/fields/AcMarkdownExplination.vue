  ...
  >
    <v-card tile class="markdown-help">
      <v-toolbar flat dark color="primary">
        <v-btn id="close-markdown-help" icon dark @click="toggle = false">
      ...
      <v-card-text>
        <v-container fluid class="py-0">
          <v-row v-if="display" dense class="markdown-rendered-help">
            <v-col class="text-center" cols="12">
              <h1>Artconomy uses Markdown!</h1>
              <p>
                Markdown is a language for enhancing your posts with links,
                lists, and other goodies. Here are some examples!
              </p>
            </v-col>
            <v-col cols="12" md="6" lg="5" offset-lg="1">
              <v-row dense>
                ...
                <v-col cols="6">
                  <v-list-subheader class="markdown-table-header">
                    Write
                  </v-list-subheader>
                </v-col>
                <v-col cols="6">
            ...
            <v-col cols="12" md="6" lg="5" offset-lg="1">
              <v-row dense class="mt-3">
                ...
                <v-col cols="12">
                  <p>
                    You can create paragraphs and other 'blocks' of text. Blocks
                    should be separated by two newlines.
                    <strong>One new line is not always enough!</strong> See
                    below.
                  </p>
                </v-col>
                <v-col cols="6">
            ...
            <v-col cols="12" md="6" lg="4" offset-lg="1">
              <v-row dense class="mt-3">
                ...
                <v-col cols="12">
                  <p>
                    You can create numbered and bullet lists.
                    <strong
                      >You don't need to track the numbers yourself!</strong
                    >
                  </p>
                  <p>
                    You can also nest paragraphs and other lists by indenting
            ...
            <v-col cols="12">
              <v-row dense class="mt-3">
                ...
                <v-col cols="12" lg="11" offset-lg="1">
                  <p>
                    You can add headers to your post. Please use these
                    sparingly.
                    <strong
                      >You must start a header at the beginning of a line for
                      this to work.</strong
                    >
                  </p>
                </v-col>
...
const blocksItems = [
  {
    ...
    display: "This is a test.<br>This is only a test.",
  },
  {
    input: "This is a test.\n\nThis is only a test.",
    display: "This is a test<br><br>This is only a test.",
  },
  {
    input:
      "> This is a block quote.\nIt continues on the next line.\n\nYou need two lines to stop here, too!",
    display:
      "&gt; This is a block quote.<br>It continues on the next line.<br><br>You need two lines to stop here, too!",
  },
  {
    input:
      "> This is another block quote.\n> \n> We can add blank lines to quotes this way.",
    display:
      "&gt; This is another block quote.<br>&gt; <br>&gt; We can add blank lines to quotes this way.",
  },
  {
    input:
      '```\n# This is a code block.\n\nfunction greet():\n    print("Hello, world!")\n\ngreet()\n```',
    display:
      '```<br># This is a code block.<br><br>function greet():<br>&nbsp;&nbsp;&nbsp;&nbsp;print("Hello, world!")<br><br>greet()<br />```',
  },
]
...
const listsItems = [
  {
    ...
    display:
      "1. Put on shoes<br>1. Tie laces<br>1. Grab keys<br>1. Forget wallet",
  },
  {
    input: "* Fox\n* Wolf\n* Human\n* Elf",
    display: "* Fox<br>* Wolf<br>* Human<br>* Elf",
  },
  {
    input: "- Fox\n+ Wolf\n+ Human\n- Elf",
    display: "- Fox<br>+ Wolf<br>+ Human<br>- Elf",
  },
  {
    ...
    display:
      "1. First item<br>&nbsp;&nbsp;&nbsp;&nbsp;* Sub item<br/>&nbsp;&nbsp;&nbsp;&nbsp;* Sub item 2<br>2. " +
...
.markdown-help kbd::before,
.markdown-help kbd::after {
  content: unset;
}
