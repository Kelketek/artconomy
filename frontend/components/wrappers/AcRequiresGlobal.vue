        ...
        >
          <v-col class="text-center shrink" align-self="center" cols="12">
            <p>
              ...
              built-in browser, or similar embedded browsers. There should be a menu
              at the top or bottom of your screen that has a link to
              'Open in browser' or 'Open in Safari' or similar.
            </p>
          </v-col>
        </v-row>
      </v-card-text>
