  ...
  >
    ...
    <v-stepper v-model="newUpload.step" class="submission-stepper" non-linear>
      <v-stepper-header>
        <v-stepper-item
          editable
          :complete="newUpload.steps[1].complete"
          :value="1"
          ...
          <v-row no-gutters>
            ...
            <v-col cols="12">
              <ac-bound-field
                ...
                :field="newUpload.fields.caption"
                label="Caption"
    ...
    <template #bottom-buttons>
      <v-card-actions row wrap>
        ...
        <v-btn
          ...
          color="secondary"
          variant="flat"
          @click.prevent="newUpload.step -= 1"
        >
          Previous
        </v-btn>
        <v-btn
          v-if="newUpload.step < 2"
          color="primary"
          variant="flat"
          @click.prevent="newUpload.step += 1"
        >
