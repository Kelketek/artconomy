<template>
  <div>
    ...
    >
      <template #default>
        <v-card-text>
          Cookies are special pieces of data that help websites keep track of
          information about a visitor. They can help with authentication, site
          improvement, and other functions. Artconomy uses the following kinds
          of cookies:
        </v-card-text>
        <v-row>
          <v-col cols="6">
          ...
          <v-col cols="6">
            Artconomy has a handful of cookies that are required for basic
            function, including those that handle authentication and your
            content settings.
          </v-col>
          <v-col cols="6">
            <v-checkbox
          ...
          <v-col cols="6">
            ...
            <a
              ...
              target="_blank"
              >Matomo Analytics</a
            >, an open source privacy-centric analytics service which does not
            share its data with third party entities. We use this to tell which
            parts of our site people use the most and where we might make
            improvements.
          </v-col>
          <v-col cols="6">
            <v-checkbox
          ...
          <v-col cols="6">
            <p>
              Artconomy may partner with third party networks in order to verify
              if integrations with those partners is working correctly, or to
              gain more insight into our customer base. For example, if we ran
              an ad on Pinterest, these cookies would help us know that these
              ads were actually being seen and followed. This helps us build a
              website more tailored to customer needs, but is the least private
              cookie we use.
            </p>
          </v-col>
        </v-row>
