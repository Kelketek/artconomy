  ...
  <div v-if="code" class="container error-container">
    <div class="row">
      ...
      <div class="col-12 text-center home-title">
        ...
        <!--suppress JSUnresolvedVariable -->
        <p v-if="code === 500">
          Something went wrong. We've notified our developers and will get it
          fixed as soon as we can!
        </p>
        <!--suppress JSUnresolvedVariable -->
        <p v-else-if="code === 503">
          Artconomy is currently updating or under maintenance. Please refresh
        ...
        <p v-else-if="code === 404">
          We couldn't find that page. It might not exist or you might not have
          the right privileges to see it.
        </p>
        <!--suppress JSUnresolvedVariable -->
        <p v-else-if="code === 403">
          Access to this page is restricted. Please make sure you're logged into
          an account that has access to it.
        </p>
        <p v-else-if="code === 451">
          Access to this content is removed for legal or administrative reasons.
        </p>
        <p v-else>
          Something weird happened. Could you please contact support and tell us
          about it?
        </p>
      </div>
    </div>
