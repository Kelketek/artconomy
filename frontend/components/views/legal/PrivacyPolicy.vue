  ...
  <v-container>
    <v-row>
      ...
      <v-col cols="12">
        ...
        <p>
          Artconomy ("us", "we", or "our") operates the https://artconomy.com/
          website (the "Service").
        </p>
        ...
        <p>
          ...
          our Terms and Conditions, accessible from https://artconomy.com/
        </p>
        ...
        <p>
          Credit card data and bank information is shared with our payment
          processor, Stripe.
        </p>
        ...
        <p>
          Artconomy will take all steps reasonably necessary to ensure that your
        ...
        <p>
          Artconomy may disclose your Personal Data in the good faith belief
          that such action is necessary to:
        </p>
        <ul>
          <li>To comply with a legal obligation</li>
          <li>To protect and defend the rights or property of Artconomy</li>
          <li>
        ...
        <p>
          We will only share this data as necessary to perform these tasks and
        ...
        <ul>
          <li>By email: info@artconomy.com</li>
        </ul>
      </v-col>
    </v-row>
  </v-container>
