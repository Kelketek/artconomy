  ...
  <v-container>
    <v-row>
      ...
      <v-col cols="12">
        ...
        <p>
          Artconomy will take all steps reasonably necessary to ensure that your data is treated securely and in
        ...
        <p>
          We will only share this data as necessary to perform these tasks and are
