      ...
      <v-card-text>
        <v-row no-gutters>
          <v-col class="text-center">
            ...
            <h3>Extra Rewards!</h3>
            <p>
              Follow our <a href="https://twitter.com/ArtconomyArt">Twitter Feed</a> for information on contests
              for things like <strong>FREE</strong> commissions!
            </p>
          </v-col>
        </v-row>
      </v-card-text>
      ...
      <template #default>
        <v-row no-gutters>
          ...
          >
            ...
            <p>
              Your total reflects all referred users, even those who have done no
              <router-link :to="{name: 'BuyAndSell', params: {question: 'shield'}}">
                Shield protected
              </router-link>
              transactions.
