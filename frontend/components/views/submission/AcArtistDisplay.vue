<template>
  <ac-load-section :controller="controller">
    <v-row dense>
      <v-tooltip v-if="editable" top aria-label="Tooltip for Artist tagger">
      ...
      <v-tooltip v-else top aria-label="Tooltip for Artists">
        <template #activator="activator">
          <v-icon v-bind="activator.props" :icon="mdiPalette" />
        </template>
        Artists
      </v-tooltip>
...
const props = defineProps<{
  controller: ListController<ArtistTag>
