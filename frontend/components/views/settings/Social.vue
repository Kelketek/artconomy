        ...
        <v-card>
          <v-card-text>
            ...
            <v-row>
              <v-col cols="12">
                <v-alert type="info">
                  We love to promote the artists using our site! These settings give us permission to promote you on
                  social media, or otherwise promote the site using your work, if you choose to allow it. <strong>Since these
                    deal with your rights, they are all opt-in. Opting in helps us all grow!</strong>
                </v-alert>
              </v-col>
              <v-col
                cols="12"
              ...
              >
                <p>
                  Check this to allow us to promote you and your content on social media. We will link/ping
                  your account on the relevant service (if you've specified it below) when we do this.
                </p>
                <ac-patch-field
              ...
              >
                <p>
                  Check this to allow us to use your content to promote the site in a general sense-- such as using
                  screenshots containing your content. We may not always ping you in this case, but we may if the content
                  is heavily focused.
                </p>
                <ac-patch-field
                  field-type="ac-checkbox"
              ...
              >
                <p>
                  Whether we may promote your NSFW content on social media which allows such content, if applicable.
                </p>
                <ac-patch-field
                  field-type="ac-checkbox"
              ...
              <v-col cols="12">
                <p>
                  A quick description of your art/style/offerings, for use by our social media specialist
                  when promoting you.
                </p>
                <ac-patch-field
              ...
              <v-col cols="12">
                <p>
                  Any other information we should know when promoting you.
                </p>
                <ac-patch-field
                  field-type="ac-editor"
        ...
        <v-card class="mt-3">
          <v-card-text>
            ...
            <v-row>
                  ...
                  >
                    <ac-load-section :controller="socialLinks">
                      <ac-form-container v-bind="socialLinkForm.bind">
                        <ac-form
                          :form="socialLinkForm"
                          @submit.prevent="socialLinkForm.submitThen(socialLinks.push)"
                        >
                          <ac-bound-field
              ...
              >
                <p>
                  <strong>This feature not yet available.</strong> Check this box to display your links to other
                  sites on your profile. Otherwise these will only be used in connection with promotional work as
                  mentioned above, or with contacting you in an emergency if your main contact isn't working.
                </p>
                <ac-patch-field
                  field-type="ac-checkbox"
