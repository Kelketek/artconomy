...
<template>
  <v-col>
    <v-row>
      ...
      >
        <p>
          Two Factor Authentication (2FA) helps keep your account secure. If someone discovers your password,
          they still will not be able to log in without being able to access a device you own.
        </p>
      ...
      >
        <v-row>
          ...
          >
            <v-card
              class="elevation-7 setup-telegram"
              @click="tgDevice.put()"
            >
              <v-card-text>
                <v-row no-gutters>
