<template>
  <v-card>
    <v-card-text>
      <v-row
        v-if="!(subjectPlan && (subjectPlan.monthly_charge || subjectPlan.per_deliverable_price))"
        no-gutters
      >
        <v-col
          class="text-center"
      ...
      >
        <v-card-text>
          <v-row v-if="!paypalWarned && !paypal.ready">
            <v-col cols="12">
              ...
              <ul>
                ...
                <li>
                  When you enable this feature, all orders which are not shield protected will use Paypal invoicing by
                  default.
                ...
                <li>
                  PayPal's terms of service is hostile toward NSFW art commissions in most or all jurisdictions and
                  circumstances.
                  <strong>You should not use PayPal to track NSFW art commissions. If you do so, you do so at your own
                    risk!</strong>
                </li>
                <li>
                  Invoices generated in PayPal will contain all relevant information, such as product names and line
                  items.
                </li>
                <li>Invoices will be denominated in USD.</li>
                <li>
                  PayPal <strong>WILL</strong> reveal your personal information to the client, and vice versa in most
          ...
          <v-row v-else-if="!paypal.ready">
            <v-col cols="12">
              <p>
                Enter your PayPal API Credentials below. <strong>These are not your username and password.</strong> You
              ...
              <ol>
                ...
                <li>
                  Under 'REST API Apps', click the 'Create App' button. You can name the app anything,
                  but you might want to name it something like 'Artconomy Integration' so you remember what it is.
                </li>
                <li>
                  <strong>Optional, but highly recommended for security:</strong> Uncheck all of the features on the
                  app aside from 'Invoicing.'
                </li>
                <li>
                  Copy your Client ID and Secret using the icons next to them, and paste them into the fields below,
                  and submit!
                </li>
              </ol>
              <v-alert
