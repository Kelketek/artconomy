...
describe("AcAttributes.vue", () => {
  ...
  test("Mounts an attribute listing", async () => {
    ...
    store.commit(
      "characterModules/character__Fox__Kai/attributes/setReady",
      true,
    )
    await nextTick()
  })
  test("Handles a new attribute", async () => {
    ...
    store.commit("characterModules/character__Fox__Kai/profile/setReady", true)
    store.commit(
      "characterModules/character__Fox__Kai/profile/setFetching",
      false,
    )
    store.commit(
      "characterModules/character__Fox__Kai/attributes/setReady",
    ...
    store.commit(
      "characterModules/character__Fox__Kai/attributes/setFetching",
      false,
    )
    await nextTick()
    vm.addAttribute({
