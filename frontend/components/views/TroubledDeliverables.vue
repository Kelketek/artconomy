      ...
      <template #default>
        <v-simple-table>
          <template #default>
            ...
            <tbody>
              <tr
                v-for="deliverable in troubledDeliverables.list"
              ...
              >
                ...
                <td>
                  <ac-avatar
                    ...
                    :user="deliverable.x!.order.buyer"
                  />
                  <span v-else>{{ deliverable.x!.order.customer_email }}</span>
                </td>
                <td>
                ...
                <td>
                  ...
                  <v-btn
                    ...
                    small
                    variant="flat"
                    @click="claimDeliverable(deliverable)"
                  >
                    Claim
                  </v-btn>
                </td>
