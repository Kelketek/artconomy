<template>
  <v-row no-gutters>
          ...
          <v-expansion-panel-title class="pa-1">
            <v-row no-gutters>
              <v-col class="text-center extra-height">
                ...
                <v-chip
                  v-if="searchForm.fields.featured.value"
                  variant="flat"
                  color="secondary"
                  class="mx-1"
                >
                ...
                <v-chip
                  v-if="searchForm.fields.rating.value"
                  variant="flat"
                  color="yellow"
                  class="mx-1"
                  light
                ...
                <v-chip
                  v-if="searchForm.fields.min_price.value"
                  variant="flat"
                  color="black"
                  class="mx-1"
                >
                ...
                <v-chip
                  v-if="searchForm.fields.max_turnaround.value"
                  variant="flat"
                  color="teal"
                  class="mx-1"
                >
                ...
                <v-chip
                  v-if="searchForm.fields.lgbt.value"
                  variant="flat"
                  color="purple"
                  class="mx-1"
                >
    ...
    <v-col
      v-if="searchForm.fields.minimum_content_rating.value > rating"
      class="py-2"
    >
