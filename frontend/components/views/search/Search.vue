        ...
        <v-col>
          ...
          <v-col class="grow">
            <v-row no-gutters>
              <v-col cols="6">
                <v-btn
                  :to="{name: 'SearchProducts', query: route.query}"
                  density="comfortable"
                  block
                  class="rounded-0"
                  variant="flat"
              ...
              <v-col cols="6">
                <v-btn
                  :to="{name: 'SearchSubmissions', query: route.query}"
                  density="comfortable"
                  block
                  class="rounded-0"
                  variant="flat"
              ...
              <v-col cols="6">
                <v-btn
                  :to="{name: 'SearchCharacters', query: route.query}"
                  density="comfortable"
                  block
                  class="rounded-0"
                  variant="flat"
              ...
              <v-col cols="6">
                <v-btn
                  :to="{name: 'SearchProfiles', query: route.query}"
                  density="comfortable"
                  block
                  class="rounded-0"
                  variant="flat"
