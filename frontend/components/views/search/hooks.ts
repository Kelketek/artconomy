...
export const useSearchForm = () => {
  ...
  form.fields.minimum_content_rating.update(fallback(query, 'minimum_content_rating', 0))
  ...
  form.fields.artists_of_color.update(fallbackBoolean(query, 'artists_of_color', false))
