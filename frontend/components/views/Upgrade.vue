                ...
                >
                  ...
                  >
                    <v-row>
                      <v-col cols="12">
                        <v-card>
                          <v-card-text class="text-center">
                            ...
                            <div>
                              Shield fee: {{ plan.shield_percentage_price }}%<sup
                                v-if="pricing.x!.international_conversion_percentage"
                              >*</sup> <span
                                v-if="plan.shield_static_price"
                      ...
                      <v-col cols="12">
                        <v-chip
                          v-if="plan.name === loggedInViewer.next_service_plan && !toFloat(plan.monthly_charge)"
                          color="gray"
                        ...
                        <template v-else>
                          <v-btn
                            v-if="!(plan.name === loggedInViewer.next_service_plan)"
                            color="primary"
                            variant="flat"
                          ...
                          <v-btn
                            v-else
                            :to="{name: 'Premium', params: {username: viewer!.username}}"
              ...
              >
                ...
                >
                  ...
                  <div class="mt-2 text-center">
                    ...
                    <p>
                      Premium services, as with all use of Artconomy's offerings, are subject to the
      ...
      <v-window-item value="completed">
        ...
        >
          ...
          <div v-if="toFloat(selectedPlan.monthly_charge)">
            ...
            <p>
              We've received your payment and your account has been upgraded! Visit your
              <router-link :to="{name: 'Premium', params: {username: viewer!.username}}">
          ...
          <div v-else>
            ...
            <div v-else>
              <v-btn
                :to="{name: 'Profile', params: {username: subject!.username}}"
                variant="flat"
              >
