            ...
            <v-col class="grow pa-1">
              <v-row no-gutters>
                ...
                <v-col cols="6" md="12" order="1" order-md="2">
                  ...
                  >
                    <v-col class="pa-1">
                      Find an artist <strong>TODAY</strong>. No more hunting
                      through journals and tweets!
                    </v-col>
                  </v-row>
                </v-col>
              </v-row>
              ...
              <v-row no-gutters>
                ...
                <v-col class="pa-1" cols="6" md="12">
                  ...
                  >
                    <v-col>
                      <p>
                        Get updates on your commission's progress, with
                        revisions and direct messages.
                      </p>
                    </v-col>
                  </v-row>
                </v-col>
            ...
            <v-col class="grow pa-1">
              <v-row no-gutters>
                ...
                <v-col class="pa-1" cols="6" md="12" order="1" order-md="2">
                  ...
                  >
                    <v-col>
                      Show off your commissions-- make a profile and gallery for
                      your characters!
                    </v-col>
                  </v-row>
                </v-col>
