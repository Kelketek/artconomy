  ...
  <v-container fluid>
    ...
    >
      ...
      >
        ...
        <p>
          Meet <strong>AWOO</strong>, the
          <strong>A</strong>rtconomy
          <strong>W</strong>orkload
          <strong>O</strong>rganization and
          <strong>O</strong>verview tool.
          Find all of your orders, broadcast announcements to your commissioners.
        </p>
        <p>
      ...
      >
        ...
        <p>
          The artistic journey is one of persistence, and it can't be done alone.
          Engage with a community of artists from different walks of life, at any level of their career.
        </p>
        <p>Trade tips with a group of people eager to help each other succeed.</p>
        <p>Join our Discord channel, and get solid advice from the Artconomy ArtSmarts blog!</p>
        <v-row>
          <v-col
            cols="12"
            lg="6"
      ...
      >
        ...
        <p>
          Communicate directly with your customer, directly on each revision. Set how many revisions are included up
          front.
        </p>
        <p>
          Customer wants wings? Add a line item for it.
          Not sure how much you're making? Our calculator can help!
        </p>
        <v-card>
          <v-card-text color="blue">
            <strong>Keep track of references and characters on every commission!</strong>
          </v-card-text>
        </v-card>
        <p>
    ...
    >
      ...
      >
        ...
        />
        <p>
          <small>Artconomy shield currently available
            ...
            payment from an outside source.</small>
        </p>
        <v-btn
          x-large
          color="green"
    ...
    >
      ...
      >
        ...
        <p>
          Great, you have an order. Now where did you put that reference? Wonder no longer!
          Every order comes with reference management, allowing customers to upload what you need.
        </p>
        <p>
          <strong>Character Listings</strong> allow you to keep track of your creations, or get a full view of your
          customer's OC!
        </p>
      </v-col>
      <v-col
