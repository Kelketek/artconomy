<template>
  <v-container fluid class="pa-0">
    <v-img :src="banner" :aspect-ratio="16/9" max-height="250px" alt="Welcome to Artconomy.com!" :eager="prerendering">
      <v-row no-gutters
             align="center"
             justify="center"
              ...
              <v-row no-gutters>
                ...
                <v-col cols="6" md="12" order="1" order-md="2">
                  <v-row no-gutters class="justify-content fill-height" align="center">
                    <v-col class="pa-1">
                      Take orders through your store. You'll never lose track of your customer's contact information, or
                      who you owe art, ever again!
                    </v-col>
                  </v-row>
                </v-col>
              </v-row>
        ...
        <v-col class="text-center d-flex" cols="12" md="4">
          <v-row no-gutters>
            <v-col class="grow pa-1">
              <v-row no-gutters>
                <v-col cols="6" md="12">
                  <v-img :src="forbidden" max-height="20vh" contain :eager="prerendering"/>
                </v-col>
            ...
            <v-col class="grow pa-1">
              <v-row no-gutters>
                ...
                <v-col class="pa-1" cols="6" md="12" order="1" order-md="2">
                  <v-row no-gutters class="justify-content fill-height" align="center">
                    <v-col>
                      Tools built just for you: Galleries, Invoicing, Workload Management, Price Negotiation, Product
                      Samples, and more!
                    </v-col>
                  </v-row>
                </v-col>
